...
class SmsNotifier(Participant):

    def update(self, game):
        print('SMS->', 'к нам присоединился', game.players[-1].name)


class EmailNotifier(Participant):

    def update(self, game):
        print(('EMAIL->', 'к нам присоединился', game.players[-1].name))
